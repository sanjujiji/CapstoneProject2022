...
import { SEARCHBARVALUE,LOGINSHOW,LOGOUTSHOW,SIGNUPSHOW,HOMESHOW,ADDPRODUCTSHOW,SEARCHBARSHOW,ORDERPLACEDSHOW,PRODUCTMODIFIEDSHOW,PRODUCTMODIFIEDNAMESHOW,ADMINSHOW } from '../dataSlice';
                        ...
                        <Toolbar sx = {{justifyContent: "space-between"}}>
                          ...
                          <div className='rightMost'>
                              <Stack direction="row" spacing={2}> 
                                  ...
                                  : null}
                                  {homeShowStore ?
                                    <Button href="/products" id = "home">Home</Button>
                                  : null}
                                  {addProductStore ?
                                    <Button href="/add" id = "addProduct">Add Product</Button>
                                  : null}
                                  {logoutShowStore ?
